...
// ------------------------------------------------------------
// GenBank → solo features, NCBI NO devuelve secuencia completa en genomas grandes
...
// FASTA → sí contiene secuencia completa
    ...
    useEffect(() => {
        async function loadGenomes() {
            ...
            for (const g of genomeList) {
                ...
                try {
                    const gbText = await fetchGenbankFeatures(acc);
                    const fasta = await fetchFastaSequence(acc);
