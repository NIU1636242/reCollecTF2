...
export default function Step5SiteAnnotation() {
    ...
    const sites = reportedSitesData?.sites || [];
    const exactHits = reportedSitesData?.exactHits || {};
    const fuzzyHits = reportedSitesData?.fuzzyHits || {};
    const choice = reportedSitesData?.choice || {};
